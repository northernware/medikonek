...
const LINKS = [
  { href: "/", label: "Today", icon: "M4 6h16M4 12h16M4 18h10" },
  { href: "/appointments", label: "Appointments", icon: "M8 3v4M16 3v4M4 9h16M5 5h14v16H5z" },
  { href: "/families", label: "Families", icon: "M4 20v-2a4 4 0 014-4h1m7 6v-2a4 4 0 00-3-3.9M9 7a3 3 0 106 0 3 3 0 10-6 0m8 3a2.5 2.5 0 100-5" },
